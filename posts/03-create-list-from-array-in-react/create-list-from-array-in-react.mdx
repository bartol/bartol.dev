...
slug: blog/create-list-from-array-in-react/
image: ./react-original.svg
imagealt: react icon
tags: ['react', 'array', 'map', 'list']
date: 2019-08-08
datetimestamp: 1565222400
foldername: 03-create-list-from-array-in-react
filename: create-list-from-array-in-react
published: true
---
