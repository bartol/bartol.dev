...
slug: blog/use-lint-staged-and-husky-to-run–eslint-on-every-commit/
image: ./eslint.svg
imagealt: eslint icon
tags: ['eslint', 'lint-staged', 'husky']
date: 2019-08-16
datetimestamp: 1565913600
foldername: 11-use-lint-staged-and-husky-to-run–eslint-on-every-commit
filename: use-lint-staged-and-husky-to-run–eslint-on-every-commit
published: true
---
...
![image of result after commit](result.png)
