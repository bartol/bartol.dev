...
slug: blog/working-html-clock-with-no-dependencies/
image: ./html5-original.svg
imagealt: html icon
tags: ['html']
date: 2019-08-17
datetimestamp: 1566000000
foldername: 12-working-html-clock-with-no-dependencies
filename: working-html-clock-with-no-dependencies
published: true
---
