...
slug: blog/put-item-in-dynamodb-table/
image: ./Amazon-DynamoDB.svg
imagealt: aws dynamodb icon
tags: ['dynamodb']
date: 2019-09-11
datetimestamp: 1568160000
foldername: 37-put-item-in-dynamodb-table
filename: put-item-in-dynamodb-table
published: true
---
