...
slug: blog/working-with-browser-local-storage/
image: ./javascript-original.svg
imagealt: javascript icon
tags: ['javascript']
date: 2019-09-13
datetimestamp: 1568332800
foldername: 39-working-with-browser-local-storage
filename: working-with-browser-local-storage
published: true
---
